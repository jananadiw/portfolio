  ...
  return (
    <div className="px-6 dark:text-slate-300">
      <main className="h-full pt-16 pb-20 align-center">
        <h3 className="m-0 leading-tight text-5xl text-center">Hello! 👋🏼</h3>

        <p className="m-16 leading-6 text-center text-xl">
          I'm Jananadi, an Expat Full-Stack Developer <br />
        ...
        <div className="max-w-5xl flex flex-wrap items-center justify-center">
          ...
          >
            ...
            <p className="mb-5 text-lg">
              Check out some work projects that I was a part of over last few
              years. They taught me a lot.{' '}
            </p>
          </Link>
          ...
          >
            ...
            <p className="mb-5 text-lg">
              Here are few projects I did and currently working on, and some
              articles.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mb-5 text-lg">
              Beside coding, I love to paint. Still an amateur, checkout some of
              my art.
            </p>
          </Link>
          ...
          >
            ...
            {/* &rarr; -> */}
            <p className="mb-5 text-lg">
              Let me introduce myself. Find my contact details here as well.
              Thanks for visiting!
            </p>
          </Link>
        </div>
